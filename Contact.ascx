...
<div class="left">
    ...
    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
        <ContentTemplate>
            ...
            <asp:RequiredFieldValidator SetFocusOnError="true" ForeColor="Red" Display="Dynamic"
                ID="RequiredFieldValidator1" runat="server" ControlToValidate="TxtName" ValidationGroup="Contact1"
            ...
            <asp:RequiredFieldValidator SetFocusOnError="true" ForeColor="Red" Display="Dynamic"
                ID="RequiredFieldValidator2" runat="server" ControlToValidate="TxtEmail"  ValidationGroup="Contact1"
                ErrorMessage="" CssClass="validPos"></asp:RequiredFieldValidator>
            <asp:RegularExpressionValidator ID="RegularExpressionValidator1" runat="server"
                ControlToValidate="TxtEmail" ErrorMessage="" CssClass="validPos"
                ValidationExpression="\w+([-+.']\w+)*@\w+([-.]\w+)*\.\w+([-.]\w+)*"
                meta:resourcekey="RegularExpressionValidator1Resource1" Display="Dynamic"  ValidationGroup="Contact1"
            ...
            <asp:TextBox ID="TxtMessage" runat="server" TextMode="MultiLine" class="area" placeholder="محتوى الرسالة"
                Style="resize: none;"></asp:TextBox>
            <asp:RequiredFieldValidator SetFocusOnError="true" ForeColor="Red" Display="Dynamic"  ValidationGroup="Contact1"
                ID="RequiredFieldValidator5" runat="server" ControlToValidate="TxtMessage" CssClass="validPos"
                ErrorMessage=""></asp:RequiredFieldValidator>


            <asp:Button ID="btnSend" runat="server" class="btns"  ValidationGroup="Contact1" CausesValidation="false"
            ...
            <div id="CaptchaDiv" runat="server" visible="false">
                ...
                <div class="inpt">
                    ...
                    <div class="txtcont">
                        ...
                        <asp:RequiredFieldValidator SetFocusOnError="true" ForeColor="Red" Display="Dynamic"
                            ID="RequiredFieldValidator6" runat="server" ControlToValidate="TxtCaptcha"  ValidationGroup="Contact1"
                            ErrorMessage="" CssClass="validPos"></asp:RequiredFieldValidator>
                    </div>
                    <div style="clear: right; height: 5px;">
                        &nbsp;
    ...
    <asp:UpdateProgress ID="UpdateProgress1" runat="server">
        <ProgressTemplate>
            <div style="position: absolute; right: 145px; top: -45px;">
